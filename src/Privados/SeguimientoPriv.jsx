...
const SeguimientoPriv = ({ isOpen, onClose, servicio, darkMode, onSave, onFinalizar, listaAsignaciones, listaHospitales }) => {
...
export default SeguimientoPriv;